...
export const downloadArticlesKCNA = async () => {
  ...
  const articleContentData = await downloadNewArticleArray(newArticleArray);
  return articleContentData;
};

export const downloadNewArticleArray = async (inputArray) => {
